 ...
 * @author Jorge
 */
public class frmVistaProductoC extends javax.swing.JFrame {
    ...
    private void tablaProductoSeleccionar(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaProductoSeleccionar
        ...
        if (evt.getClickCount()==2) {
            ...
            frmCompra.txtproducto.setText(valor1);
            frmCompra.txtprecio_venta.setText(valor2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaProductoC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVistaProductoC().setVisible(true);
            }
        });
    }
